...
<div>
                  ...
                  <v-card class="pa-5 mb-5" variant="outlined" id="estimation-form">
                    <v-card-title class="px-0">{{ isEditing ? "Edit Estimation" : "Add New Estimation" }}
                    </v-card-title>
                    <v-row>
                      <v-col cols="12" md="6">
                        <v-select
                        ...
                        >
                          <template v-slot:append>
                            <v-btn color="primary" variant="tonal" size="small" @click="$emit('open-client-dialog')" height="40">
                              + New
                            </v-btn>
                          </template>
                        </v-select>
                      ...
                      <tbody>
                        <tr v-for="estimation in estimations" :key="estimation.id">
                          ...
                          <td class="text-center">
                            ...
                            <v-btn color="error" size="small" class="ml-3" @click="$emit('delete', estimation.id)">Delete</v-btn>
                          </td>
                        </tr>
                      </tbody>
                    </v-table>
