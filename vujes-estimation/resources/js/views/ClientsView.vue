...
<h2 class="text-h4 mb-4">Clients</h2>
        ...
        <v-row>
          ...
          <v-col cols="12" md="4">
            <v-text-field v-model="clientForm.email" label="Email" type="email" density="compact"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
        ...
        <v-btn v-if="isEditing" color="dark-grey" variant="text" class="ml-2" @click="$emit('cancel')">
          Cancel
        </v-btn>
        </div>
        </v-card>
        ...
        <v-table>
          ...
          <tbody>
            <tr v-for="client in clients" :key="client.id">
              ...
              <td class="text-center"><v-btn color='warning' size='small' @click="$emit('edit', client)">Edit</v-btn>
                <v-btn color="error" size="small" class="ml-3" @click="$emit('delete', client.id)">Delete</v-btn>
              </td>
            </tr>
          </tbody>
        </v-table>
